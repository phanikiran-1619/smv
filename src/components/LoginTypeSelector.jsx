    ...
    <Card className="w-full max-w-md mx-auto bg-card border-2 border-yellow-500/30 shadow-xl backdrop-blur-sm">
      <div className="p-8 space-y-6">
        ...
        <div className="text-center space-y-3">
          ...
          <h3 className="text-2xl font-bold text-yellow-500">School Bus Management</h3>
        ...
        <div className="space-y-4">
          <Select value={selectedLoginType} onValueChange={setSelectedLoginType}>
            <SelectTrigger className="w-full bg-background border-border text-foreground hover:bg-muted transition-all duration-200 h-12 text-base">
