...
const Navbar = ({ showBackButton = false }) => {
  ...
  return (
    <>
      <nav className="fixed top-0 left-0 right-0 z-40 dark:bg-slate-800/95 bg-sky-400/95 backdrop-blur-sm border-b dark:border-slate-600 border-sky-500/30 shadow-sm">
            ...
            <div className="flex items-center gap-4">
              {showBackButton && (
                <Button
                  ...
                  size="sm"
                  onClick={() => navigate(-1)}
                  className="dark:text-gray-300 dark:hover:text-white dark:hover:bg-slate-700 text-white hover:text-sky-100 hover:bg-sky-500/30 transition-colors duration-200"
                >
              ...
              <div className="flex items-center gap-2">
                ...
                <h1 className="text-lg font-bold">
                  <span className="dark:text-yellow-500 text-white">School Bus</span>
                  <span className="dark:text-white text-white ml-1">Tracker</span>
                </h1>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3">
              ...
              {showProfileButton && (
                <button
                  ...
                  className={`w-10 h-10 rounded-full bg-gradient-to-br ${userData ? getProfileGradient(userData.roles?.[0]) : 'from-gray-500 to-gray-600'} flex items-center justify-center text-white text-sm font-bold shadow-lg hover:shadow-xl transition-all duration-200 transform hover:scale-105 border-2 dark:border-slate-600 border-sky-600/60`}
                  title="Profile"
                >
