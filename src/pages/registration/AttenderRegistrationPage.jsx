...
import { UserCheck, Save, RotateCcw, FileDown } from 'lucide-react';
...
const AttenderRegistrationPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!formData.smAttenderId || !formData.firstName || !formData.lastName || !formData.phone) {
    ...
    try {
      ...
      const url = mode === 'register' 
        ...
        : `${API_BASE_URL}/attender/${formData.smAttenderId}`;
      ...
      setSuccess(`Attender ${mode === 'register' ? 'registered' : 'updated'} successfully!`);
      ...
      setError(error.response?.data?.message || `Failed to ${mode} attender`);
    } finally {
      setLoading(false);
    }
  };
      ...
      <div className="pt-24 px-4 pb-8">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-300">Register and manage attender information</p>
          </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => handleInputChange('smAttenderId', e.target.value)}
                ...
                >
                  {loading ? (
                    ...
                    <span className="flex items-center">
                      ...
                      {mode === 'register' ? 'Register Attender' : 'Update Attender'}
                    </span>
                  )}
                </Button>
